package com.examenfinal.app.infraestructure;
...
@Configuration
@ComponentScan("com.examenfinal.app.domain")
@PropertySource("classpath:application.properties")
@EnableJpaRepositories("com.examenfinal.app.infraestructure.*")
public class ExamenFinalConfig {
    @Autowired
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        emf.setPackagesToScan(Cliente.class.getPackage().getName());
